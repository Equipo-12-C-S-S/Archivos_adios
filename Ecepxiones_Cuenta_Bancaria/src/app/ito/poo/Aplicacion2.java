...
//============================================================
		  static void grabaregistroDat() throws IOException {
			  if(!c.isFree()) {
				  informacion3 = new RandomAccessFile("CuentasBancarias.dat","rw");
				  for(int i=0;i<c.getSize();i++) {
					  informacion3.writeLong(c.getItem(i).getNumCuenta());
					  informacion3.writeUTF(c.getItem(i).getNomCliente());
					  System.out.println("Numero de cuenta"+c.getItem(i).getNumCuenta());
					  informacion3.writeFloat(c.getItem(i).getSaldo());
					  informacion3.writeUTF(c.getItem(i).getFechaApertura().toString());
					  if(c.getItem(i).getFechaActualizacicon()==null)
						  informacion3.writeUTF("Sin fecha de actualizacion \n");
					  else
					  informacion3.writeUTF(c.getItem(i).getFechaActualizacicon().toString()+"\n");
				  }
				}
	  ...
	  /*static void leerArchivo() {
	   ...
	   static void menuoperac() throws CuentaException, EliminaException, RetiroException, ExcepcionRetiro, IOException {
		   inicializa();
		   int opcio;
		  ...
		  while(bandera) {	  
			  ...
			  switch(opcio){
			  	...
			  	case 7:grabaregistro();grabaregistroDat();bandera=false;break;
		     }
	      }
	   }
